...
//   const AtoE=expect(Fare_Class.charCodeAt(0)).toBeGreaterThanOrEqual(65)
//   if(AtoE){
//    let a= expect(Fare_Class.charCodeAt(0)).toBeLessThanOrEqual(69);
//    console.log(a,'kajal')
//      if(a)passed_data[i]['discount_code'] = 'OFFER_20'
//   }
// }
// catch(e){
//    console.log(e,'ee1')
//   }
// try{
//   const FtoK=expect(Fare_Class.charCodeAt(0)).toBeGreaterThanOrEqual(70)
//   if(FtoK){
//     let a=expect(Fare_Class.charCodeAt(0)).toBeLessThanOrEqual(75);
//     passed_data[i]['discount_code'] = 'OFFER_20'
//    console.log(a,'kajal')

//     if(a)
//     {
//        passed_data['discount_code'] = 'OFFER_30'
//     }
...
//   }
// try{
//   const LtoR=expect(Fare_Class.charCodeAt(0)).toBeGreaterThanOrEqual(76)
//   if(LtoR){
//    let a= expect(Fare_Class.charCodeAt(0)).toBeLessThanOrEqual(82)
//    console.log(a,'kajal')

//     passed_data['discount_code'] = 'OFFER_25'
...
// }
// try{
//   const nocode=expect(Fare_Class.charCodeAt(0)).toBeGreaterThanOrEqual(83)
//   if(nocode){
//    let a= expect(Fare_Class.charCodeAt(0)).toBeLessThanOrEqual(90)
//    console.log(a,'kajal')

//    if(a) passed_data['discount_code'] = 'No offer code'
...
// try {
//   const info = expect(Fare_Class.charCodeAt(0)).toBeGreaterThanOrEqual(65);
//   if (info) {
//    let p= expect(Fare_Class.charCodeAt(0)).toBeGreaterThanOrEqual(69);
//    console.log(p,'pppp')
//   }
// }
// catch{
...
// console.log(Fare_Class.charCodeAt(0),'Fare_Class.charCodeAt(0)')
